...
dependencies {
    ...
    classpath("dev.buijs.klutter:core:2022.r6-5.alpha")
    classpath("dev.buijs.klutter.gradle:dev.buijs.klutter.gradle.gradle.plugin:2022.r6-5.alpha")
}
```
...
- Klutter Core version 2022.r6-5.alpha
- Klutter Gradle version 2022.r6-5.alpha
...
In a terminal run: <I>flutter pub run klutter:consumer add=batterylevel</I>
