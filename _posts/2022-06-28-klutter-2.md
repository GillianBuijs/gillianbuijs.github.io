...
- Install the Klutter Framework as dependency:
  - Add klutter: ^0.2.1 to your pubspec.yaml dependencies block.
...
dependencies {
    ...
    classpath("dev.buijs.klutter:kore:2022.r6-8.alpha")
    classpath("dev.buijs.klutter:klutter-gradle:2022.r6-8.alpha")
}
```
